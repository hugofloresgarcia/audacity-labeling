...
namespace CPUType {
  ...
  std::tuple<Tensor &,Tensor &> nanmedian_out_dim_values(Tensor & values, Tensor & indices, const Tensor & self, int64_t dim, bool keepdim);
  ...
  std::vector<Tensor> _foreach_add_ScalarList(TensorList tensors, ArrayRef<double> scalars);
  void _foreach_add__ScalarList(TensorList self, ArrayRef<double> scalars);
  std::vector<Tensor> _foreach_sub_ScalarList(TensorList tensors, ArrayRef<double> scalars);
  void _foreach_sub__ScalarList(TensorList self, ArrayRef<double> scalars);
  std::vector<Tensor> _foreach_div_ScalarList(TensorList tensors, ArrayRef<double> scalars);
  void _foreach_div__ScalarList(TensorList self, ArrayRef<double> scalars);
  std::vector<Tensor> _foreach_mul_ScalarList(TensorList tensors, ArrayRef<double> scalars);
  void _foreach_mul__ScalarList(TensorList self, ArrayRef<double> scalars);
  ...
  void _foreach_addcdiv__Scalar(TensorList self, TensorList tensor1, TensorList tensor2, Scalar value);
  void _foreach_addcmul__Scalar(TensorList self, TensorList tensor1, TensorList tensor2, Scalar value);
  void _foreach_addcdiv__ScalarList(TensorList self, TensorList tensor1, TensorList tensor2, ArrayRef<double> scalars);
  void _foreach_addcmul__ScalarList(TensorList self, TensorList tensor1, TensorList tensor2, ArrayRef<double> scalars);
  std::vector<Tensor> _foreach_addcdiv_Scalar(TensorList input, TensorList tensor1, TensorList tensor2, Scalar value);
  std::vector<Tensor> _foreach_addcmul_Scalar(TensorList input, TensorList tensor1, TensorList tensor2, Scalar value);
  std::vector<Tensor> _foreach_addcdiv_ScalarList(TensorList input, TensorList tensor1, TensorList tensor2, ArrayRef<double> scalars);
  std::vector<Tensor> _foreach_addcmul_ScalarList(TensorList input, TensorList tensor1, TensorList tensor2, ArrayRef<double> scalars);
  std::vector<Tensor> _foreach_maximum_List(TensorList tensors1, TensorList tensors2);
  std::vector<Tensor> _foreach_minimum_List(TensorList tensors1, TensorList tensors2);
