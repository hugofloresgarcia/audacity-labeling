...
namespace TypeDefault {
  ...
  std::tuple<Tensor,Tensor> nanmedian_names_dim(const Tensor & self, Dimname dim, bool keepdim);
  std::tuple<Tensor &,Tensor &> nanmedian_out_names_dim_values(Tensor & values, Tensor & indices, const Tensor & self, Dimname dim, bool keepdim);
  ...
  Tensor & nan_to_num_out_out(Tensor & out, const Tensor & self, c10::optional<double> nan, c10::optional<double> posinf, c10::optional<double> neginf);
  ...
  std::tuple<Tensor,Tensor> nanmedian_dim(const Tensor & self, int64_t dim, bool keepdim);
