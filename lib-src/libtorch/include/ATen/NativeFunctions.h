...
CAFFE2_API Tensor vulkan_mm(const Tensor & self, const Tensor & mat2);
...
CAFFE2_API Tensor & scatter_cpu_reduce_(Tensor & self, int64_t dim, const Tensor & index, const Tensor & src, std::string reduce);
CAFFE2_API Tensor & scatter_cpu_scalar_reduce_(Tensor & self, int64_t dim, const Tensor & index, Scalar value, std::string reduce);
...
CAFFE2_API std::tuple<Tensor,Tensor> _min_max(const Tensor & self);
